    ...
    <div className="w-full">
      <input
        ...
        className={cn(
          ...
          error ? "border-red-400 bg-red-50 dark:border-red-800 dark:bg-red-950/40" : "border-zinc-200 bg-white hover:border-zinc-300 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:border-zinc-600",
          className
        )}
        {...props}
      />
